...
% słowa» (slowa.tex), «Zdania» (zdania.tex) y, cuando llegue, el nivel
% 3. Lo que cambia cada día (las palabras, los enunciados, la clave) lo
% escribe el generador de cada cuaderno.
%
