...
% słowa» (slowa.tex), «Zdania» (zdania.tex) y «Czytam z lupą»
% (czytam.tex). Lo que cambia cada día (las palabras, los enunciados, la
% clave) lo escribe el generador de cada cuaderno.
%
...
% -----------------------------------------------------------------------
% «Zdania», el cuaderno de frases en polaco (zdania.tex, ver ZDANIA en
% tools/libros.py): usa las cadenas de arriba, las del cuaderno de
% frases. Aquí, las dos que el cuaderno en español no tiene: el nombre
% del nivel en la portada (el de frases es "Aprendo a leer" a secas) y
% la instrucción de "Połącz" (en español la escribe el generador, ver
% Libro.instruccion_relaciona). Las parejas no siempre son un nombre y
% quién es ("Po kolacji" -- "wszyscy śpiewają kolędy"): por eso, pary.
% -----------------------------------------------------------------------
\newcommand{\lblZdNivelPortada}{Zdania}
\newcommand{\lblInstruccionRelaciona}{Połącz linią pary, które do siebie pasują.}

% -----------------------------------------------------------------------
% El nivel 3 en polaco, «Czytam z lupą» ("Leo con lupa", ver lang/es.tex):
% lo propio de ese nivel. En medio del diagrama de "Porównaj", lo que
% tienen en común las dos cosas que se comparan: «wspólne», que vale
% para personas, animales y cosas (el «los dos» del español tendría en
% polaco tres formas, oba, obie u oboje, según lo que se compare).
% -----------------------------------------------------------------------
