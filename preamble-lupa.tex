...
% Mensaje secreto. La tabla del código de números va en dos filas: de 14
% columnas para las 27 letras del español, de 16 para las 32 del polaco
% (\begin{tablaCodigo}[16], ver render_codigo en tools/lupa.py).
\newenvironment{tablaCodigo}[1][14]{%
