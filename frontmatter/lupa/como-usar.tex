% frontmatter/lupa/como-usar.tex -- instrucciones para el adulto.
\section*{Cómo usar este cuaderno}

Este es el tercer cuaderno de la serie, después de \textit{Primeras
palabras} (nivel 1) y el cuaderno de frases (nivel 2). Está pensado para
una niña o un niño que ya lee con soltura frases completas y compuestas
-- por ejemplo, porque ha terminado el cuaderno de frases -- y que ahora
da el paso siguiente: entender oraciones largas, con varias partes unidas por
