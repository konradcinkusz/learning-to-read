...
% \def\booklang{en}, y los cuadernos en polaco (slowa.tex...),
% \def\booklang{pl}; los cuadernos en español no lo definen y se quedan
...
% babel-spanish, abajo) y qué fichero de cadenas se carga (lang/es.tex,
% lang/en.tex o lang/pl.tex, ver "cadenas de texto").
\makeatletter
\def\aal@booklang@en{en}
\def\aal@booklang@pl{pl}
\@ifundefined{booklang}{\def\booklang{es}}{}
\ifx\booklang\aal@booklang@en
  \usepackage[british]{babel}
\else\ifx\booklang\aal@booklang@pl
  % babel-polish también hace activa la " (para "-, "< ...): lo mismo que
  % con el español, más abajo, y por lo mismo.
...
%     cuaderno en inglés y lang/pl.tex en los de polaco -- ver \booklang
%     arriba) -------------------------------------------------------------
\input{lang/\booklang}
