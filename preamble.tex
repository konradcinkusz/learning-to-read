...
% "completa" si no se fija (los 260 días) o "verano": solo los 65 días
% del verano (del 196 al 260), impresos como días 1 a 65 y semanas 1
% a 13, sin trimestre -- un cuaderno de verano. Lo que cambia está todo
% aquí: el sufijo de los .tex generados (content/generated-days-verano.tex,
% que escriben los generadores), cuánto se resta al número del día y al
% de la semana al imprimirlos (la etiqueta dia:N sigue siendo la de
% siempre, para tools/check_pages.py) y \totaldias. tools/ediciones.py
% tiene los mismos números, y los generadores comprueban que coinciden.
\makeatletter
...
% de verano: \segunEdicion{todo el año}{todo el verano}.
...
% =========================================================================
% La portada de un cuaderno de verano es la del libro entero con una
% insignia debajo del título (\insigniaEdicion, que en el libro entero no
% pone nada), y en vez del mapa del curso lleva el mapa del verano
...
\newcommand{\insigniaEdicion}{%
  \ifedicionverano
    \par\vspace{7mm}%
    \begin{tcolorbox}[enhanced, hbox, center, colback=white, colframe=colorVerano,
      boxrule=1.4pt, arc=4mm, left=4mm, right=6mm, top=2mm, bottom=2mm]
      {\color{colorVerano}\solVerano}\hspace{3mm}%
      {\Large\bfseries\color{colorVerano}\lblInsigniaVerano}%
    \end{tcolorbox}%
  \fi}
