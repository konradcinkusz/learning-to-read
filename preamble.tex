...
% negrita y el borde grueso ya distinguen la caja en blanco y negro.
...
\definecolor{colorColorea}{HTML}{C2185B}
\definecolor{colorColoreaClaro}{HTML}{FBE9EF}
...
\newtcolorbox{cajaColorea}{cajabase,
  colback=colorColoreaClaro, colframe=colorColorea, colbacktitle=colorColorea,
  title=\lblColorea}
...
% \resizebox al 92% del ancho disponible -- así el dibujo siempre llena
% la caja sin desbordar el margen, sea cual sea su tamaño natural en
% diagrams/*.tex (no hay que ajustar una escala a mano por dibujo).
\newcommand{\actividadColorea}[1]{\begin{cajaColorea}\centering\resizebox{0.97\linewidth}{!}{#1}\vspace{12mm}\end{cajaColorea}}
