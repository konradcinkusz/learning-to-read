...
Tres cuadernos diarios de lectura en español, uno por nivel, con la
misma familia (los dos primeros cuentan el mismo año con los mismos
temas semana a semana; el tercero, el año siguiente):
...
make all-formats  # los seis PDF: palabras, frases y lupa, color Y blanco-y-negro
...
body.tex, body-palabras.tex, body-lupa.tex -- orden del documento de cada cuaderno
frontmatter/                          -- portada, instrucciones, mapa del curso (frontmatter/palabras/: nivel 1; frontmatter/lupa/: nivel 3, con "Cómo lee un detective" y el carné del club)
...
backmatter/diploma.tex, clave-respuestas.tex -- diploma y clave de respuestas (backmatter/palabras/: nivel 1; backmatter/lupa/: nivel 3)
...
tools/metricas.py                     -- mide palabras/frase/vocabulario nuevo contra content/progresion.json (y subordinadas, con --libro lupa)
...
El motor -- LaTeX (`preamble*.tex`, `lang/es.tex`, `main*.tex`, `palabras*.tex`, `lupa*.tex`, `body*.tex`),
...
trama de `content/*.json`, `content/palabras/*.json` y
`content/lupa/*.json`, y lo que se genera de ahí a las páginas de los
tres cuadernos --
