...
% y en bandera (\raggedright): sin guiones, una frase justificada con un
% hueco para escribir dentro (The missing words) estiraba los espacios
% de su primera línea hasta dejarla irreconocible.
\newtcolorbox{actividadIngles}[2]{cajabase,
  ...
  before lower={\raggedright\hyphenpenalty=10000\exhyphenpenalty=10000}}
...
% Rodea: las opciones, grandes y separadas, debajo de su pregunta -- en
% una línea (#1, separadas por \separaOpciones) si caben, y si no, una
% debajo de otra (#2, separadas por \par): se mide aquí, con la letra de
% verdad, en vez de adivinarlo desde tools/english.py. Una opción partida
% entre dos líneas ya no se sabe dónde empieza y dónde acaba.
\newsavebox{\cajaOpciones}
\newcommand{\opcionesRodea}[2]{%
  \sbox{\cajaOpciones}{\fontsize{18}{24}\selectfont #1}%
  \ifdim\wd\cajaOpciones>\linewidth
    \par\vspace{1.5mm}{\fontsize{17}{23}\selectfont\leftskip=10mm #2\par}\vspace{4mm}%
  \else
    \par\vspace{3mm}{\centering\usebox{\cajaOpciones}\par}\vspace{7mm}%
  \fi}
...
% actividad, que lo lee la niña. 6,5 cm: con 7,5, un viernes de texto
% largo (el día 105) ya no cabía en la página.
\newcommand{\vinetaIng}[2]{%
  \framebox[\linewidth]{\rule{0pt}{6.5cm}}\par\vspace{1.5mm}
